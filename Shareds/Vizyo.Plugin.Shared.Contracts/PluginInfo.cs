...
namespace Vizyo.Plugin.Shared.Contracts
{
    public class PluginInfo
    {
        ...
        public string PluginType { get; set; } = string.Empty; // "View", "ViewModel", "ViewControl", "ViewScript", "Service"
        ...
        public string EntryFile { get; set; } = string.Empty; // axaml, cs or dll file name
    }
}
