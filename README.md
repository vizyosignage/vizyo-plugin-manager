...
We are considering three different plugin types, and we must ensure that they work seamlessly on Windows, Linux, Android (for client player app) and  WASM Browser (for plugin viewer via web-based host app).
